...
| **TC8**  | **E_EC2** (Invalid)                                  | None                              | `unknown@eshop.com` | _(Not Reached)_   | _(Not Reached)_ | Error: Email not registered          | Error: User not found                                                      | Pass    |
| **TC9**  | **E_EC3** (Invalid)                                  | None                              | `testeshop.com`     | _(Not Reached)_   | _(Not Reached)_ | Error: Invalid email format          | Error: User not found                                                      | Fail    |
...
| **TC20** | **O_EC7** (Invalid)                                  | None                              | `test@eshop.com`    | `[Expired OTP]`   | `Aa1@bcde`      | Error: OTP expired                   | Unable to submit for testing due to password error in the form             | Blocked |
| **TC21** | **O_EC8** (Invalid)                                  | None                              | `test@eshop.com`    | `[Used OTP]`      | `Aa1@bcde`      | Error: OTP already used              | Unable to submit for testing due to password error in the form             | Blocked |
