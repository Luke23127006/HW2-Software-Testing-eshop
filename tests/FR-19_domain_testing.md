...
**1. Input: Actor/Role** 
* *Rule applied: "Must Be" condition (Valid JWT AND role='admin').*
...
**2. Input: Action**
* *Rule applied: "Set of Values" (View List, Delete).*
* **ACT_EC1 (Valid):** View User List
* **ACT_EC2 (Valid):** Delete User

**3. Input: Target User ID**
* *Rule applied: "Must Be" condition (Must NOT be the currently logged-in account).*
